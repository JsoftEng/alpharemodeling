module.exports = {
  siteTitle: 'Alpha Remodeling', // Site title.
  ...
  userDescription: '',
  copyright: 'Copyright © Alpha Remodeling 2018-2019. All Rights Reserved.', // Copyright string for the footer of the website and RSS feed.
